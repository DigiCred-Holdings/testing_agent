...
import type { CredentialStateChangedEvent, InitConfig } from '@credo-ts/core'
import { Agent, ConnectionsModule, CredentialEventTypes, CredentialsModule, CredentialState, MediationRecipientModule, MediatorPickupStrategy, V2CredentialProtocol } from '@credo-ts/core'
